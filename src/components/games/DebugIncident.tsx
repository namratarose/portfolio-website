...
const LEVELS: Level[] = [
  {
    ...
    services: [
      ...
      { id: 'blockchain', name: 'Blockchain Node', icon: '🔗', status: 'ok' },
  ...
  },
  {
    ...
    difficulty: 'HARD',
    description: 'Two services are deadlocked waiting for each other\'s locks. Blockchain transactions halted. You have 60 seconds and must fix TWO services in the correct order.',
    timerSeconds: 60,
    logs: [
      '[22:07:11] ERROR  blockchain-listener | Deadlock detected: waiting for lock held by reward-service',
      '[22:07:11] ERROR  reward-service      | Deadlock detected: waiting for lock held by blockchain-listener',
      '[22:07:12] ERROR  blockchain-listener | Transaction batch #8841 stalled — 0 confirmations in 90s',
      '[22:07:12] ERROR  reward-service      | Reward settlement frozen — cannot acquire ledger lock',
      '[22:07:13] CRIT   blockchain-listener | 1,247 pending transactions unprocessed',
      ...
      '[22:07:16] ALERT  oncall              | P0 — blockchain + rewards down. Engineers paged x3',
    ],
    services: [
      ...
      { id: 'blockchain', name: 'Blockchain Node', icon: '🔗', status: 'down', errorSym: 'DEADLOCK' },
      { id: 'queue', name: 'Message Queue', icon: '📨', status: 'ok' },
    ],
    ...
    fixPhases: [
      {
        ...
        prompt: 'Step 1/2: Blockchain listener is deadlocked. Break the cycle first.',
        options: [
          { id: 'a', text: 'Force-release blockchain-listener\'s locks and restart with lock ordering enforced', correct: true },
          { id: 'b', text: 'Kill the reward-service first to break the deadlock', correct: false, consequence: 'Reward service dies. Blockchain listener keeps waiting for its own ghost. Deadlock persists. Nice try.' },
          ...
          { id: 'd', text: 'Disable distributed locking entirely', correct: false, consequence: 'Both services now process the same transactions. Double payouts. Legal is calling.' },
        ],
        deployMessage: 'Force-releasing blockchain-listener locks... enforcing lock acquisition order: ledger → blockchain... deadlock cycle broken... listener resuming batch #8841...',
      },
      {
        serviceId: 'db',
        ...
        deployMessage: 'Applying idempotency keys to pending rewards... re-acquiring locks in correct order: ledger → blockchain... processing 1,247 queued transactions... settlement complete... $84,200 distributed.',
      },
    ],
  },
]
